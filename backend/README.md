...
## Project Structure
    ...
    ├── testapiautodatamod_110070  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_110070`
...
2. Clone this repo and `cd testapiautodatamod_110070`
